...
SECRET_KEY = 'h6k*7col6si#-4j#{SECRET_KEY}##kc(vs!%z#{SECRET_KEY}+l1uhjsxy#{SECRET_KEY}1m$u)n=dj4qnq'
...
AUTH_USER_MODEL = "crypto_app.MyUser"
...
MIDDLEWARE = [
    ...
    'crypto_web.middleware.force_default_middleware.force_default_language_middleware',
